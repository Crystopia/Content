...
<TagLinks tag="step1" title="Step 1: Launch Minecraft" type="text-5xl" />
...
<TagLinks tag="step2" title="Step 2: Go to Multiplayer" type="text-5xl" />
...
<TagLinks tag="step3" title="Step 3: Add the Server Crystopia.net" type="text-5xl" />
